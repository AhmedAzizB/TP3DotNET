...
namespace TP3.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Privacy()
        {
            ...
            SQLiteConnection dbCon = new SQLiteConnection("Data Source=C:\\Users\\defaultuser0\\Downloads\\2022 GL3 .NET Framework TP3 - SQLite database.db;");
            dbCon.Open();
            ...
            using (dbCon)
            {
                ...
                using (reader)
                {
                    while (reader.Read())
                    {
                        ...
                        //   on avait un probleme avec les cases DateTime
